...
class DealerParser:
    ...
    def __init__(self):
        ...
        bin6 = pp.oneOf("|| or")
        ternary = ("?", ":")
        operator = pp.infixNotation(func | number | symbol, [(unary1, 1, pp.opAssoc.RIGHT, Node.from_unaryop), (bin1, 2, pp.opAssoc.LEFT, Node.from_binaryop), (bin2, 2, pp.opAssoc.LEFT, Node.from_binaryop), (bin3, 2, pp.opAssoc.LEFT, Node.from_binaryop), (bin4, 2, pp.opAssoc.LEFT, Node.from_binaryop), (bin5, 2, pp.opAssoc.LEFT, Node.from_binaryop), (bin6, 2, pp.opAssoc.LEFT, Node.from_binaryop), (ternary, 3, pp.opAssoc.RIGHT, Node.from_ternaryop)])
        expr <<= operator
