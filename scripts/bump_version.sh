...
# update config.py
sed -i "s/__version__ = .*/__version__ = \"$MAJOR.$MINOR.$PATCH\"/g" 'src/endplay/config.py'
sed -i "s/__version_info__ = .*/__version__ = ($MAJOR, $MINOR, $PATCH)/g" 'src/endplay/config.py'
